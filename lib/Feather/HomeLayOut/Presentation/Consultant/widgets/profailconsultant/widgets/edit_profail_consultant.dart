...
class EditProfailConsultant extends StatefulWidget {
  const EditProfailConsultant({super.key});

  @override
  State<EditProfailConsultant> createState() => _EditProfailConsultantState();
}

class _EditProfailConsultantState extends State<EditProfailConsultant> {
  var selectedType;
